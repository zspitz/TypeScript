...
namespace ts {
    ...
    const ellipsis = "...";
    const categoryFormatMap = createNumberMap<DiagnosticCategory, string>([
    ...
    export function executeCommandLine(args: string[]): void {
        ...
        function performCompilation() {
            ...
            cachedExistingFiles = createStringMap<boolean>();
    ...
    function printHelp() {
        ...
        const optionsDescriptionMap = createStringMap<string[]>();  // Map between option.description and list of option.type if it is a kind
